 ...
 */
package org.opendaylight.I4application.cli.commands;
...
public class I4applicationCliTestCommand extends AbstractAction {

    private static final Logger LOG = LoggerFactory.getLogger(I4applicationCliTestCommand.class);
    protected final I4applicationCliCommands service;

    public I4applicationCliTestCommand(final I4applicationCliCommands service) {
